...
class Main:
    def __init__(self, entry_column=None, magic_number=0.5, dead_end_behaviour="CREATE_EXIT"):
        ...
        self.dead_end_behaviour = dead_end_behaviour  # "CREATE_EXIT" or "CREATE_TREASURE"
